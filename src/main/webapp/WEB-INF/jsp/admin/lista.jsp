						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-footer">
							      <div class="vote-buttons">
							        <a class="like-it" href="<c:url value="/admin/gostei?ideia=${i.id}"/>">
							        	Gostei <i class="fa fa-thumbs-up"></i>
							        </a>
							    	<a class="dont-like-it" href="<c:url value="/admin/naogostei?ideia=${i.id}"/>">
							    		Não Gostei  <i class="fa fa-thumbs-down"></i>
							    	</a>
							      </div>
